...
shinyUI(fluidPage(
    ...
    fluidRow(
        column(3,
               ...
               selectInput('plotType', 'Plot Method:',
                           choices = c("DensityPlot", "boxplot", "DataSummary"),
                           selected = "Density",
                           width = "100%"),
               uiOutput("markerChoose"),

               checkboxInput("scaleHeight", label = "Scale Density Height", value = FALSE),
               checkboxInput("scaleWidth", label = "Scale Density Width", value = FALSE),
               ...
               fluidRow(
                   column(6,
                          selectInput('transformation1', 'Transformation Method 1:',
                                      choices = c("autoLgcl", "logicle", "cytofAsinh", "arcsinh"),
                                      selected = "autoLgcl",
                                      width = "100%"),
                   ...
                   column(6,
                          selectInput('transformation2', 'Transformation Method 2:',
                                      choices = c("cytofAsinh", "arcsinh", "autoLgcl", "logicle"),
                                      selected = "cytofAsinh",
                                      width = "100%"),
